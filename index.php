        ...
        <nav id="navbar_top" class="navbar navbar-expand-lg navbar-light bg-white shadow">
          ...
          <div class="card shadow" style="width: 90%;">
            ...
            <div class="card-body">
              ...
              <a href="aboutus.html" class="btn btn-about position-static fw-bold font-inter">About Us</a>
              ...
              <div class="col-sm">
                <div class="card cardsstyle mx-auto" style="max-width: auto;">
                    ...
                    <div class="card-body mx-auto">
                      <a href="ourproduct.html" class="btn btnproducts ">Stickers</a>
                    </div>
                  </div>
              </div>
              <div class="col-sm">
                <div class="card cardsstyle mx-auto" style="max-width: auto;">
                    ...
                    <div class="card-body mx-auto">
                        <a href="ourproduct.html" class="btn btnproducts">Posters</a>
                    </div>
                  </div>
              </div>
              <div class="col-sm">
                <div class="card cardsstyle mx-auto" style="max-width: auto;">
                    ...
                    <div class="card-body mx-auto">
                      <a href="ourproduct.html" class="btn btnproducts">Cards</a>
                    </div>
                  </div>
              </div>
              <div class="col-sm">
                <div class="card cardsstyle mx-auto" style="max-width: auto;">
                    ...
                    <div class="card-body mx-auto">
                      <a href="ourproduct.html" class="btn btnproducts">Print A4</a>
                    </div>
                  </div>
              </div>
            </div>
